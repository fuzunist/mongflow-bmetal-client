...
import { addSelectProduct, addSelectSet, setCustomer, setProduct, setSelectProducts, setSelectSets, setSet } from '@/store/actions/apps'
...
const ProformaInvoice = () => {
    ...
    const handleContinueOrder = (attributes, quantity, productType, closeModal, setQuantity, setProductType) => {
    ...
    const handleContinueOrderSet = (attributes, quantity, productType, closeModal, setQuantity, setProductType) => {
